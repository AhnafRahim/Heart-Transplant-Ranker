...
public class HeartTransplant {
    ...
    {
        //initializing surviveabilitybyage object
    ...
    public Patient[] getPatientsWithAgeAbove(int age) 
    {
        ...
        //seeing how many patients are above the age
        for(int i = 0; i < patients.length; i++)
        {
    ...
    {
        //First: need to find out which patient will survive the longest if given a heart
        //Second: need to remove this patient from the patient array because they dont need a heart anymore
        //Third: return the patient from the array 

        //patient from the patient array
        //Patient[] person = new Patient[patients.length]; 
        Patient person[] = new Patient[patients.length];
        int p = 0;

        //looping through to see if the patient needs a heart and returning them if they do. 
        for(int i = 0; i < patients.length; i++)
        {
            person[i] = patients[i]; 
